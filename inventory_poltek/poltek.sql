...
--
-- Host: localhost
-- Generation Time: Jul 17, 2013 at 10:22 AM
...
('d4a3fe7c2a886763a7678418c94d0d44', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.71 Safari/537.36', 1374047547, 'a:7:{s:9:"user_data";s:0:"";s:9:"logged_in";s:13:"aingLoginYeuh";s:8:"username";s:5:"admin";s:12:"nama_lengkap";s:13:"Administrator";s:4:"foto";s:16:"ayah_profile.jpg";s:5:"level";s:11:"Super Admin";s:6:"gudang";s:1:"2";}');
...
CREATE TABLE `d_pesan` (
  ...
  PRIMARY KEY (`kode_pesan`,`kode_barang`),
  KEY `kode_barang` (`kode_barang`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `gudang` (
  `id_gudang` smallint(6) NOT NULL AUTO_INCREMENT,
