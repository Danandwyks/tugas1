...
class Barang extends CI_Controller {
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$text = "SELECT kode_barang,nama_barang FROM barang $where ";		
	...
	public function simpan()
	{
		...
		if(!empty($cek)){
				...
				$up['satuan']		="0";//$this->input->post('satuan');
				$up['harga_beli']	="0";//$this->input->post('hrg_beli');
				$up['harga_jual']	="0";//$this->input->post('hrg_jual');
				$up['stok_awal']	="0";//$this->input->post('stok_awal');
				$up['id_gudang']	="0";//$this->input->post('gudang');
