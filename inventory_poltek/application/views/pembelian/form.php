...
<td valign="top" width="50%">
    ...
    <tr>    
        <td>Satuan</td>
        <td>:</td>
        <td><input type="text" name="satuan" id="satuan"  size="20" class="detail" maxlength="20" /></td>
    </tr>
    <tr>    
        <td>Harga</td>
        <td>:</td>
...
<div id="dlg" class="easyui-dialog" title="Daftar Warna" style="width:900px;height:400px; padding:5px;" data-options="closed:true">
