...
<th>KODE DOSEN.</th>      
    ...
    <th>ALAMAT</th>   
        ...
        $sql = mysqli_query($koneksi, "SELECT a.id, a.kd_dosen,a.nama_dosen, a.alamat,a.email, a.hp
        from dosen as a
       ") 
or die(mysqli_error($koneksi)); 
    //jika query diatas menghasilkan nilai > 0 maka menjalankan script di bawah if...  
        ...
        <td>'.$data['hp'].'</td>      
        <td>   
        <a href="edit2.php?id='.$data['id'].'" class="badge badge-warning">Edit</a>  
        <a href="delete2.php?id='.$data['id'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>    
    </td>    
        </tr>    
        ';    
        $no++;    
