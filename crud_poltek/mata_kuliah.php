...
<div id="mbinsmenu0ebul_wrapper" style="max-width: 100%;">
  ...
  <li><div class="buttonbg gradient_button gradient27" style="width: 100%;"><a href="mata_kuliah.php">MATA KULIAH</a></div></li>
...
<th>SKS.</th>      
        ...
        $sql = mysqli_query($koneksi, "SELECT a.id,a.kd_mk, a.nama_mk,a.sks
...
or die(mysqli_error($koneksi)); 
    //jika query diatas menghasilkan nilai > 0 maka menjalankan script di bawah if...  
        ...
        <td>'.$data['sks'].'</td>   	
        <td>   
        <a href="edit4.php?id='.$data['id'].'" class="badge badge-warning">Edit</a>  
        <a href="delete4.php?id='.$data['id'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>    
    </td>    
        </tr>    
        ';    
        $no++;    
